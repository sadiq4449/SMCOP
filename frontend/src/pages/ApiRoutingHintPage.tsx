...
export function ApiRoutingHintPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6 py-12 text-center">
      <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-text-muted">SMOCP Portal</p>
      <h1 className="mt-4 max-w-lg text-2xl font-semibold tracking-tight text-text-primary">
        This URL should hit the API, not the web app
      </h1>
      ...
      <p className="mt-4 max-w-xl text-xs text-text-muted">
        Details: <code className="text-text-secondary">supabase/README.txt</code> (Vercel section).
      </p>
    </div>
  )
}
