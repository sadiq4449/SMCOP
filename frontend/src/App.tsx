        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            <Route element={<AppShell />}>
              ...
              <Route path="/dashboard/users" element={<PlaceholderPage title="Users" />} />
              ...
              <Route path="/dashboard/visits" element={<PlaceholderPage title="Field Visits" />} />
              <Route path="/dashboard/assigned-schools" element={<PlaceholderPage title="Assigned Schools" />} />
              <Route path="/dashboard/monitoring" element={<PlaceholderPage title="Monitoring Visits" />} />
